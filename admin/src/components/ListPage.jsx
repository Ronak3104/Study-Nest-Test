...
const ListPage = () => {
  ...
  // getting the star rating component
      ...
      <div className={listStyles.contentContainer}>
        <div className={listStyles.headerContainer}>
          ...
          <p className={listStyles.headerSubtitle}>
            Manage and browse all courses in your platform. Click on a course to
            view details, edit, or remove it from the catalog.
          </p>
        </div>
          ...
          {!loading && filteredCourses.length === 0 && (
            <div className={listStyles.emptyState}>
              ...
              <p className={listStyles.emptyText}>
                No courses found matching {searchTerm}. Try adjusting your
